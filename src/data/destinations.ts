...
export const destinations: Destination[] = [
  {
    ...
    },
    {
        ...
        duration: '8 days / 7 nights',
        departureCity: 'Ahmedabad',
        availableDates: ['Sep 26 - Oct 3, 2025', 'Oct 3 - Oct 10, 2025', 'Oct 6 - Oct 13, 2025', 'Nov 10 - Nov 17, 2025', 'Dec 5 - Dec 12, 2025'],
        itinerary: [
        {
            day: 1,
            title: 'Departure from Ahmedabad',
    ...
    attractions: [
      ...
      },
      {
        name: 'Backwaters',
        imageUrl:
          'https://images.unsplash.com/photo-1593693397640-052a21e4a3c0?q=80&w=2574&auto=format&fit=crop',
      },
      {
        name: 'Munnar',
        imageUrl:
          'https://images.unsplash.com/photo-1549923028-595a6332c21c?q=80&w=2574&auto=format&fit=crop',
      },
    ],
    departureCities: [
      {
